    ...
    <div className={cn("p-8 md:p-12", className)}>
      <div className="max-w-7xl mx-auto w-full">
        ...
        <div className="flex flex-col md:grid md:grid-cols-2 gap-6 md:gap-10">
          ...
          <div
            className={cn(
              "order-1 md:order-2 relative h-[200px] md:h-[300px] lg:h-[400px] overflow-hidden rounded-lg shadow-2xl"
            )}
          >
            ...
            {/* Progress bar */}
            <div className="absolute bottom-4 left-4 right-4 h-1 bg-gray-200 rounded-full overflow-hidden">
              <motion.div
